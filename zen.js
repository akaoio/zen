...
defmod('./src/scan.js', function(module, exp){
  /**
   ...
   * Supports formats:
   *   peer1.akao.io    → peer{N}.akao.io and peer.akao.io
   ...
   */
  function scanip6(addresses, opt = {}) {
  ...
  exp.mkpat = mkpat;
  exp.bdom = bdom;
  exp.candidateHosts = candidateHosts;
  exp.scan = scan;
  exp.scanip6 = scanip6;
  exp.scanbg = scanbg;
});
...
defmod('./src/axe.js', function(module, exp){
  var { mkpat, candidateHosts } = reqmod('./src/scan.js');
