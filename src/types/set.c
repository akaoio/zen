 ...
 * @return New ZenSet instance or NULL on memory allocation failure
 */
 ...
 * @param set Set structure to free (may be NULL)
 */
 ...
 * @param value Value to generate key for (may be NULL)
 * @return Allocated string key or NULL on memory allocation failure
 */
 ...
 * @param set Set Value to add item to
 * @param item Value to add to the set
 * @return Boolean Value indicating success (true if added, false if already exists) or error Value
 */
 ...
 * @param set Set Value to check
 * @param item Value to search for
 * @return Boolean Value indicating whether item is in set or error Value
 */
 ...
 * @param set Set Value to remove item from
 * @param item Value to remove from the set
 * @return Boolean Value indicating success (true if removed, false if not found) or error Value
 */
Value *set_remove(Value *set, const Value *item)
{
    ...
    object_delete(set_data->hash_table, key);
    bool removed = true;  // Assume success for now
    memory_free(key);
 ...
 * @param set Set Value to get size of
 * @return Number Value representing the count of items in the set or error Value
 */
 ...
 * @param set Set Value to convert
 * @return Array Value containing all items in the set or error Value
 */
 ...
 * @return New Set Value containing all items from both sets or error Value
 */
 ...
 * @param set1 First Set Value
 * @param set2 Second Set Value
 * @return New Set Value containing items present in both sets or error Value
 */
 ...
 * @param set1 First Set Value (minuend)
 * @param set2 Second Set Value (subtrahend)
 * @return New Set Value containing items in set1 but not in set2 or error Value
 */
 ...
 * @param subset Set Value to check as potential subset
 * @param superset Set Value to check as potential superset
 * @return Boolean Value indicating whether subset is contained within superset or error Value
 */
