 ...
 */
void visitor_enable_optimizations(visitor_T* visitor, bool tail_call_opt, bool constant_fold, bool dead_code_elim);
 ...
 */
void visitor_throw_exception(visitor_T* visitor, AST_T* exception_value, const char* message, const char* source_location);
