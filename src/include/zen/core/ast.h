 ...
 */
AST_T* ast_new_logical_theorem(const char* name, AST_T** hypotheses, size_t hyp_size, AST_T* conclusion);
 ...
 */
AST_T* ast_new_logical_proof_step(AST_T* statement, AST_T* justification, AST_T** premises, size_t premises_size);
