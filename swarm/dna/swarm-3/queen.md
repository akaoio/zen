...
Created: 2025-08-05T15:21:39.212Z
...
TASK_FILE=$(node task.js create swarm-3-zen-queen "Queen coordination and strategy analysis for swarm swarm-3" MANIFEST.json ARCHITECTURE.md | grep "Created task:" | cut -d' ' -f3)
