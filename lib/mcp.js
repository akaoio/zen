...
async function call(name, args) {
  ...
  if (name === "protocol") {
    ...
    // Soul-only ops — no private key needed
    ...
    if (op === "invite") {
      // Read current version from meta (stored as individual ZEN keys, not JSON)
