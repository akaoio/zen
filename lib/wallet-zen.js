 ...
 */
;(function(){
    var Gun = (typeof window !== "undefined") ? window.Gun : (typeof global !== "undefined" && global.Gun) ? global.Gun : (typeof require !== "undefined" ? require('../gun') : undefined);
    var ZEN = (typeof Gun !== "undefined" && Gun.ZEN) ? Gun.ZEN : (typeof window !== "undefined" ? window.ZEN : (typeof global !== "undefined" && global.ZEN) ? global.ZEN : (typeof require !== "undefined" ? require('../zen') : undefined));
    ...
    if (typeof module !== "undefined" && module.exports) {
        ...
        exports.wallet = ZEN ? ZEN.wallet : undefined;
    } else if (typeof globalThis !== "undefined" && !ZEN) {
        globalThis.zenWalletDerive = async function(pair, id) { 
            if (!pair || !pair.priv) {
                throw new Error("È richiesto un ZEN pair valido, contenente la chiave 'priv'.");
            }
            return await getSeed(pair.priv, id); 
        };
    }
}());
