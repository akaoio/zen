...
/**
 * vprs(url) — validate a peer URL scheme (http/https/ws/wss), including
 * bracket-IPv6 forms like ws://[::1]:8420/zen. Shared with script/server.js.
 */
export function vprs(u) {
  return /^(https?|wss?):\/\/.+/i.test(String(u || ""));
}

// Exported for tests — bracket-wraps bare IPv6 hosts for URL building.
export { hostInUrl };
