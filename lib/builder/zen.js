...
function bundle() {
  ...
  var out = "";
  // Node.js v18 ESM does not expose globalThis.crypto without
  // --experimental-global-webcrypto. Polyfill it lazily using top-level
  // await so all platforms (Node 18/19+, browsers) are covered.
  out += "if (typeof globalThis !== 'undefined' && typeof globalThis.crypto === 'undefined') {\n";
  out += "  try { globalThis.crypto = (await import('node:crypto')).webcrypto; } catch (_) {}\n";
  out += "}\n\n";
